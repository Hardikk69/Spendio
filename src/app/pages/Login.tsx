...
import { CreditCard, Shield, TrendingUp, Eye, EyeOff } from "lucide-react";
            ...
            <CardContent className="p-8 md:p-10">
              ...
              <div className="mt-8">
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                  <Button variant="outline" type="button" className="h-11 border-slate-300 hover:border-slate-400 hover:bg-slate-50">
