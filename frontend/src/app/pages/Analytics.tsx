...
export default function Analytics() {
  ...
  const topSubscriptions = [
    ...
    { name: "Adobe Creative", subscribers: 234, revenue: 12866, growth: 5 },
    { name: "Disney+", subscribers: 289, revenue: 2309, growth: 18 },
  ];

  const stats = [
    { label: "Total Subscribers", value: "2,234", change: "+10.9%", trend: "up", icon: Users },
    { label: "Monthly Revenue", value: "₹27,64,280", change: "+10.9%", trend: "up", icon: DollarSign },
    { label: "Churn Rate", value: "3.3%", change: "-0.3%", trend: "down", icon: TrendingDown },
    { label: "Active Subscriptions", value: "8,456", change: "+5.2%", trend: "up", icon: Activity },
  ];
